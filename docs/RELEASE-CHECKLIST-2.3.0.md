...
Estos puntos no bloquean el cierre técnico 2.3.0 y se completarán cuando se decida publicar:

- [ ] Hosting productivo.
- [ ] Base de datos productiva.
- [ ] Dominio y HTTPS productivos.
- [ ] SMTP productivo.
- [ ] Secretos productivos definitivos.
- [ ] Webhook productivo con URL estable.
- [ ] Precios comerciales definitivos.
- [ ] Smoke test productivo.
- [ ] Publicación en sitio personal.
