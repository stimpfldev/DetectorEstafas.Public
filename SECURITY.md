...
La versión estable vigente, **2.0.2**, y la rama principal reciben correcciones de seguridad. Las versiones anteriores pueden no recibir correcciones.
...
- bypass de cuotas;
- expiración o cambio de plan de clientes API;
