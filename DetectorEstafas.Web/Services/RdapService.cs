...
public class RdapService : IRdapService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            string ruta =
                $"domain/{Uri.EscapeDataString(dominioNormalizado)}";
    ...
    private static DateTime? ObtenerFechaRegistro(
        JsonElement raiz)
    {
        ...
        foreach (JsonElement evento
                 in eventos.EnumerateArray())
        {
